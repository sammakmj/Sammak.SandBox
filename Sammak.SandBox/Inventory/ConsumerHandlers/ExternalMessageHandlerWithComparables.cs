...
{
    public class ExternalMessageHandlerWithComparables : QueueHandler
    {
        ...
        public ExternalMessageHandlerWithComparables(ILogger logger, IExternalMessageEngine externalMessageEngine) : base(logger)
        {
            _logger = logger;
        ...
        public override void Handle(string body)
        {
            ...
            //{
            var payload = JsonConvert.DeserializeObject<ComparableExternalMessagePayload>(body);

            _externalMessageEngine.ProcessWithComparables(payload);
            //}
        }
