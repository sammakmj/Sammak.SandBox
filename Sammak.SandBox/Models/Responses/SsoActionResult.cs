...
namespace Sammak.SandBox.Models.Responses
{
    /// <summary>
    /// 
    /// </summary>
    ...
    {
        /// <summary>
        /// Cast <see cref="ActionResultBase.ResultType"/> to <see cref="SsoResultType"/> for easier reading of the result
        /// </summary>
        ...
        public override string ResultTypeDescription { get { return ((SsoResultType)ResultType).GetDescription(); } }
